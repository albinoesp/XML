...
public class Procesamiento extends DefaultHandler {
    private static final String CLASS_NAME = Procesamiento.class.getName();
    ...
    public static void main(String args[]) {
        ...
        Procesamiento handler = new Procesamiento();
